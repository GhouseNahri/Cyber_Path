...
(
  ...
  '{"virtualization","linux-fundamentals","networking-models","ip-addressing","http-https-tls","tls","python-basics","security-domains"}',
...
(
  ...
  '{"python-basics","python-automation","bash-scripting","javascript-basics","linux-fundamentals","http-https-tls","tls","virtualization","ethics-and-law"}',
